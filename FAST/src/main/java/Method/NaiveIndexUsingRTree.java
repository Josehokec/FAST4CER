...
public class NaiveIndexUsingRTree extends Index {
    ...
    public void initial(){
        ...
        // Currently, there is no analysis of its cost function, so it is not necessary to use a reservoir
    }
    public NaiveIndexUsingRTree(String indexName){
        super(indexName);
    }
    ...
    public int countQuery(EventPattern pattern, AbstractJoinStrategy join){
        ...
        for(int i = 0; i < patternLen; ++i){
            ...
            List<IthRID> curIthRID = getRIDList(triples, i);
